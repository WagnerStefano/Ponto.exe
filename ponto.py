...
def ainda_em_atendimento():
    enviar_email("Status: Ainda em atendimento", "Ainda em atendimento no Cliente.")


def finalizando():
    enviar_email("Status: Finalizando", "Atendimentos finaliados, encerrando expediente.")
